						...
						<div class="row">
					        ...
					        ?>
                                            ...
                                            <div class="col-xs-12" style="border: 1px solid black;">
										        <h4 style="padding: 2px;"><?php echo $row1['b_tradename'] ?></h4>
										    </div>
										    </div>
										    <div class="row">
										    <div class="col-xs-3" style="border: 1px solid black;">
										    ...
										    <div class="col-xs-3" style="border: 1px solid black;">
                                             ...
                                             <div class="col-xs-9" style="border: 1px solid black;">
                                                    <p style="margin: 10px 0 10px 0;"><?php echo $tradetype; ?></p>
                                             </div>
										    ...
										    <div class="col-xs-3" style="border: 1px solid black;padding-bottom:8px;">
                                             ...
                                             <div class="col-xs-2" style="border: 1px solid black;">
                                                   <p style="margin: 10px 0 18px 0;"><?php echo $row1['b_cost']; ?>.00<br>&nbsp;&nbsp;&nbsp;&nbsp;0.00<br><br><br><br><br><br><?php echo $row1['b_cost']; ?>.00</p><br>
                                             </div>
                                             </div>
                                             <div class="row">
										    <div class="col-xs-3" style="border: 1px solid black;">
