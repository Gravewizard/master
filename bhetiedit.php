...
color: #F5F3F3;
						         ...
						         <?php
										...
										<div class="card-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="p_applicantname" id="p_applicantname" class="form-control" value="<?php echo $row['name']; ?>" <?php if($login_session!='lakhya') { ?> readonly <?php } ?>>
												</div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-2 control-label">Father/Husband Name</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="p_fathersname" name="p_fathersname" value="<?php echo $row['fathersname']; ?>" <?php if($login_session!='lakhya') { ?> readonly <?php } ?>>
                                                </div>
                                            </div>
											<div class="form-group">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="bhetino" name="bhetino" value="<?php echo $row['bhetino']; ?>" <?php if($login_session!='lakhya') { ?> readonly <?php } ?>>
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Bredth(in feet)</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="bhetibredthfeet" name="bhetibredthfeet" value="<?php echo $row['area_b_feet']; ?>"  <?php if($login_session!='lakhya') { ?> readonly <?php } ?>>
                                                </div>
                                                <label class="col-md-2 control-label">Bredth(in inch)</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="bhetibredthinch" name="bhetibredthinch" value="<?php echo $row['area_b_inch']; ?>"  <?php if($login_session!='lakhya') { ?> readonly <?php } ?>>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Length(in feet)</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="bhetilengthfeet" name="bhetilengthfeet" value="<?php echo $row['area_l_feet']; ?>" <?php if($login_session!='lakhya') { ?> readonly <?php } ?> >
                                                </div>
                                                <label class="col-md-2 control-label">Length(in inch)</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="bhetilengthinch" name="bhetilengthinch" value="<?php echo $row['area_l_inch']; ?>" <?php if($login_session!='lakhya') { ?> readonly <?php } ?> >
                                                </div>
                                            </div>
  ...
  document.getElementById('total').value = d;
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="total_area" name="total_area" value="<?php echo $row['total_area']; ?>" <?php if($login_session!='lakhya') { ?> readonly <?php } ?> >
                                                </div>
