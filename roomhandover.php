<?php
 ...
 if($_POST)
 {
   ...
   $select=mysqli_query($link,"SELECT COUNT(*) FROM roomownership");
 ...
 $demandupto = mysqli_real_escape_string($link, $_POST['demandupto']);
 ...
 $sql="INSERT INTO roomownership(id,r_roomno,demandupto,o_ownerfathername,o_ownername,o_ownerphone) VALUES($s,'$r_roomno','$demandupto','$o_ownerfathername','$o_ownername','$o_ownerphone')";
						     ...
						     <div class="col-md-12">
										...
										<div class="card-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="demandupto" id="demandupto" class="form-control" placeholder="Room Demand" required>
                                                </div>
                                            </div>
