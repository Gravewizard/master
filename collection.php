        ...
        <div id="page-wrapper">
            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <!-- Start of collection of Bheti amount -->
                        <div class="row">
                            <div class="col-sm-12">
                                
                                    <form role="search" class="navbar-left app-search pull-center">
                                         <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Enter Name...." class="form-control">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Listing below the bhetis</h4>
                                    
                                    <div class="table-responsive">
                                        
<table id="myTable">
  <tr class="header">
    <th style="width:50%;">Bheti Name</th>
    <th style="width:50%;">Option</th>
					                            ...
					                            ?>
  <tr>
    <td><?php echo $row['b_bhetiname']; ?></td>
    <td><a href="bhetipay.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Pay Amount</button></a></td>
  </tr>
  <?php } ?>
    ...
    if (td) {
      if (td.innerHTML.toUpperCase().indexOf(filter) > -1) {
        ...
        tr[i].style.display = "none";
                        ...
                        <!-- End of collection of Bheti amount -->
...
<table id="myTable1">
  ...
  <tr>
    ...
    <td><a href="roompay.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Pay Amount</button></a></td>
  </tr>
  <?php } ?>
    ...
    if (td1) {
      if (td1.innerHTML.toUpperCase().indexOf(filter1) > -1) {
        ...
        tr1[j].style.display = "none";
                        ...
                        <!-- Start of collection of Trade License amount -->
                        <div class="row">
                            <div class="col-sm-12">
                                
                                     <form role="search" class="navbar-left app-search pull-center">
                                         <input type="text" id="myInput2" onkeyup="myFunctiontrade()" placeholder="Enter Name...." class="form-control">
                                         <a href=""><i class="fa fa-search"></i></a>
									</form>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Listing below the pending trade license</h4>
                                    <div class="table-responsive">
...
<table id="myTable2">
  <tr class="header">
    ...
    <th style="width:50%;">Option for View/Payment</th>
                                                ...
                                                <?php
					                        		$product_array = "SELECT * FROM applytrade";
							                        $rs = mysqli_query($link,$product_array);
							                        while($row = mysqli_fetch_array($rs)) {
					                            ?>
  <tr>
    <td><?php echo $row['p_applicantname']; ?></td>
      <?php if($row['payment']==1) { ?> <td>
                                                        <a href="tradelicencedetails.php?id=<?php echo $row['id']; ?>"><button type="button" id="button1" class="btn btn-success" >View</button></a>
                                                       
                                                        <!--<a href="tradelicencedetailspay.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Pay Amount</button></a>
                                                        <a href="tradelicenceedit.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Edit</button></a>-->
                                                        </td><?php } ?>
   <?php if($row['payment']==0) { ?> <td>
                                                        <a href="tradelicencedetails.php?id=<?php echo $row['id']; ?>"><button type="button" id="button1" class="btn btn-success" >View</button></a>
    ...
    if (td2) {
      if (td2.innerHTML.toUpperCase().indexOf(filter2) > -1) {
        ...
        tr2[k].style.display = "none";
                        ...
                        <!-- End of collection of Trade License amount -->
                    </div>
                    <!-- end container -->
