...
<table id="myTable1">
  <tr class="header">
    <th style="width:33.3%;">Owner Name</th>
    <th style="width:33.3%;">Room no.</th>
    <th style="width:33.3%;">Option</th>
  </tr>
                                                <?php
  ...
  <tr>
    ...
    <td><a href="receiptroom.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Print Receipt</button></a></td>
  </tr>
  <?php } ?>
