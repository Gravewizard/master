...
$id=intval($_GET['id']);
 ...
 $sql="UPDATE ishdp_collection SET p_applicantname='$p_applicantname',p_mobile='$p_mobile',p_address='$p_address',p_amountpayable='$p_amountpayable',p_allotmentno='$p_allotmentno',
                ...
                <div id="page-right-content">
                    ...
                    <div class="container-fluid">
						...
						<div class="row">
						     <div class="col-md-12">
						                <div class="head">
										        <h4 style="float:left;">ISHDP Collection</h4>
										</div>
