<?php
 ...
 if($_POST)
 {
   ...
   $date=date('Y-m-d');
   $dateofupload = $date;
 $sql1="INSERT INTO paytrade(id,p_applicantname,wardno,oldholdingno,arrearptax,arrearltax,demandptax,demandltax,total,rebate,fine,bheti,road,rid,dateofupload,nameuser) VALUES($s,'$p_applicantname','$wardno','$oldholdingno','$arrearptax','$arrearltax','$demandptax','$demandltax','$total','$rebate','$fine','$bheti','$road','$rid','$dateofupload','$login_session')";

 $sql="UPDATE holdingownership SET payment=1 WHERE id='$id'";
...
overflow: visible;
                    ...
                    <div class="container" style="height: 700px;overflow: hidden;overflow-y: scroll;">
						...
						<div class="row">
						     <div class="col-md-12">
										...
										<?php
					                        		$product_array = "SELECT * FROM holdingownership where id='$id'";
    ...
    ">Personal Details</h4>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <input type="text" class="form-control" id="p_mobile" name="p_mobile" value="<?php echo $row['mobile']; ?>" readonly>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <input type="text" class="form-control" id="oldholdingno" name="oldholdingno" value="<?php echo $row['holding']; ?>" readonly>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Arrear(L.Tax)</label>
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <input type="text" class="form-control" id="arrearltax" name="arrarltax" value="<?php echo $row['arrearltax']; ?>" readonly>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-2 control-label">Total(Demand+Arrear)</label>
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
