...
if($_POST)
{
  ...
  $sql1="INSERT INTO paytrade(id,p_applicantname,rid,dateofupload,bookno,sno,bhetino,arrear,demand,total,fine,rebate,nameuser) VALUES($s1,'$p_applicantname','$ridd','$dateofupload','$bookno','$sno','$bhetino','$arrear','$demand','$total','$fine','$rebate','$login_session')";
  $sql2="UPDATE bhetirenewal SET renewed=1,rid='$ridd',offpayment=1 WHERE id='$idd'";
        ...
        <div class="container" style="height: 600px; overflow: hidden; overflow-y: scroll;">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <h4 class="m-t-0">Offline Bheti Renew Registrar</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <h4><center>Bheti Renewal Demand 2017-2018</center></h4>
              <form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
                <div class="card-box">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input type="text" class="form-control" id="bhetino" name="bhetino" onkeyup="loaddatabheti();" placeholder="Bheti No" required>
                    </div>
                  </div>
