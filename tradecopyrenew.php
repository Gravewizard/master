                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 600px; overflow: hidden; overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Old applied trade license</h4>
...
<table id="myTable">
  ...
  <?php
					                        		$product_array = "SELECT * FROM tradecopyrenewal";
  ...
  <tr>
    ...
    <td>                                                     
        <a href="tradelicence7.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Renew</button></a>
        <a href="tradelicencerenewedit.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Edit</button></a>
    </td>
  </tr>
  <?php } ?>
