                        ...
                        <div class="row">
                             <div class="col-md-12">
                                        ...
                                        <form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
                                            <?php
                                                    $product_array = "SELECT * FROM roommonthly where rid='$id'";
                                                    $rs = mysqli_query($link,$product_array);
                                                    
                                                    while($row = mysqli_fetch_array($rs)) { 
                                            ?>
                                        <div class="card-box">
                                            <h4>Received From : <?php echo $row['o_ownername']; ?></h4>
                                            <h4>Room No : <?php echo $row['r_roomno']; ?></h4>
                                            ...
                                            <tbody style="border: 1px solid black;">
                                                ...
                                                <th scope="row">1</th>
                                                <td>Paid Amount Of Room for (<?php echo strtoupper($row['month']); ?>) months of the session 2018-2019</td>
                                                ...
                                                <?php $total=$row['fine']+$row['rebate']+$row['amount']+$row['arrearupto']; ?>
                                                <tr style="border: 1px solid black;">
                                                <th scope="row"></th>
                                                <td>Net Amount</td>
