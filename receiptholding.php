						     ...
						     <div class="col-md-12">
						     		<?php
										...
										<div class="card-box">
                                            ...
                                            <h5>Holding No: <?php echo $row['holding']; ?></h5>
                                            ...
                                            <tbody style="border: 1px solid black;">
                                                ...
                                                <th scope="row">1</th>
                                                <?php if($row1['id']>295){ ?>
                                                <td>Holding Property Tax for the year of 2018-2019</td>
                                                <?php }
                                                else { ?>
                                                <td>Holding Property Tax for the year of 2017-2018</td>
                                                <?php } ?>
                                                ...
                                                <th scope="row">2</th>
                                                <?php if($row1['id']>295){ ?>
                                                <td>Holding Light Tax for the year of 2018-2019</td>
                                                <?php }
                                                else { ?>
                                                <td>Holding Light Tax for the year of 2017-2018</td>
                                                <?php } ?>
                                                ...
                                                <th scope="row">3</th>
                                                <?php if($row1['id']>295){ ?>
                                                <td>Holding Property Tax(Arrear)</td>
                                                <?php }
                                                else { ?>
                                                <td>Holding Property Tax(Arrear)</td>
                                                <?php } ?>
                                                ...
                                                <th scope="row">4</th>
                                                <?php if($row1['id']>295){ ?>
                                                <td>Holding Light Tax(Arrear)</td>
                                                <?php }
                                                else { ?>
                                                <td>Holding Light Tax(Arrear)</td>
                                                <?php } ?>
                                                ...
                                                <?php $total=$row['demandptax']+$row['demandltax']+$row['arrearptax']+$row['arrearltax']+$row['rebate']+$row['fine']; ?>
                                                <tr style="border: 1px solid black;">
                                                <th scope="row"></th>
                                                <td>Net Amount</td>
