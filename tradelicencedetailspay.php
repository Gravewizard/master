<?php
   ...
   include('session.php');
	 ...
	 $select1=mysqli_query($link,"SELECT COUNT(*) FROM approvedtrade");
 ...
 if($_POST)
 {
   ...
   $date=date('Y-m-d');
   $dateofupload = $date;
 $sql1="INSERT INTO paytrade(id,p_applicantname,b_tradetype,b_tradename,b_cost,rid,dateofupload,nameuser) VALUES($s,'$p_applicantname','$b_tradetype','$b_tradename','$b_cost','$rid','$dateofupload','$login_session')";

 $sql2="INSERT INTO approvedtrade(id,p_applicantname,b_tradetype,b_tradename,b_cost,rid,dateofupload) VALUES($s1,'$p_applicantname','$b_tradetype','$b_tradename','$b_cost','$rid','$dateofupload')";
 $sql="UPDATE applytrade SET payment=1 WHERE id='$id'";
    ...
    ">Personal Details</h4>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                    <input type="text" class="form-control" id="p_village" name="p_village" value="<?php echo $row['p_village']; ?>" readonly>
                                                </div>
                                            </div>
      ...
      ?>
                                           ...
                                           <div class="form-group">
											...
											<div class="form-group">
                                                <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Village</label>
                                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                    <input type="text" class="form-control" id="b_village" name="b_village" value="<?php echo $row['b_village']; ?>" readonly>
                                                </div>
