<?php
 ...
 $select=mysqli_query($link,"SELECT COUNT(*) FROM misc_collection");
 ...
 $chqdrft = mysqli_real_escape_string($link, $_POST['chqdrft']);
 $chqdrftno = mysqli_real_escape_string($link, $_POST['chqdrftno']);

 $sql="INSERT INTO misc_collection(id,p_applicantname,p_mobile,p_address,p_amountpayable,p_allotmentno,p_referno,p_amount,chqdrft,chqdrftno) VALUES($s,'$p_applicantname','$p_mobile','$p_address','$p_amountpayable','$p_allotmentno','$p_referno','$p_amount','$chqdrft','$chqdrftno')";
						...
						<div class="row">
						     <div class="col-md-12">
										...
										<div class="card-box">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="p_amountpayable" id="p_amountpayable">
                                                        ...
                                                        <option value="Trade Licence Online Application Fees">Trade Licence Online Application Fees</option>
                                                        <option value="Allotment of Bazar Bheti">Allotment of Bazar Bheti</option>
                                                        <option value="Allotment of Bazar Room">Allotment of Bazar Room</option>
                                                        <option value="Death Cerificate">Death Certificate</option>
                                                        <option value="Lease Amount of Market">Lease Amount of Market</option>
                                                        <option value="Lease Amount of Parking">Lease Amount of Parking</option>
                                                        <option value="NOC FEES">NOC FEES</option>
                                                        <option value="NOC FOR EECTRIFICATION">NOC FOR ELECTRIFICATION</option>
                                                        <option value="NOC FOR TRADE">NOC FOR TRADE</option>
                                                        <option value="ISHDP Room">ISHDP ROOM</option>
                                                        <option value="Residential Certificate Fees">Residential Certificate Fees</option>
                                                        <option value="Record Correction Fees of Holding">Record Correction Fees of Holding</option>
                                                        <option value="Lease amount of Beel/Ghat">Lease amount of Beel/Ghat</option>
                                                        <option value="Record correction of Bazar Bheti">Record correction of Bazar Bheti</option>
                                                        <option value="Record Correction of Room">Record Correction of Room</option>
                                                        <option value="Tender Form Fee">Tender Form Fee</option>
                                                        <option value="Tax Clearance Certificate">Tax Clearance Certificate</option>
                                                        <option value="Application form fee">Application form fee</option>
                                                        <option value="Children Park Fee">Children Park Fee</option>
                                                        <option value="Building Permission fee">Building Permission fee</option>
                                                        <option value="Mutation Fee">Mutation Fee</option>
                                                        <option value="Mobile Tower Installation">Mobile Tower Installation</option>
                                            ...
                                            <div class="form-group">
                                              <label class="col-md-2 control-label">Payment By</label>
                                                <div class="col-md-10">
                                            <label class="radio-inline">
                                               <input type="radio" name="chqdrft" id="chqdrft">Cheque
                                            </label>
                                            <label class="radio-inline">
                                              <input type="radio" name="chqdrft" id="chqdrft" >Draft
                                            </label>
                                          </div>
                                          </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Cheque No. / Draft No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="chqdrftno" name="chqdrftno" placeholder="Enter Cheque/Draft No">
                                                </div>
                                            </div>
										</div>
