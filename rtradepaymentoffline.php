<?php
 ...
 $licenceno = mysqli_real_escape_string($link, $_POST['licenceno']);
  ...
  $arrear= mysqli_real_escape_string($link, $_POST['arrear']);	
  $rid= mysqli_real_escape_string($link, $_POST['rid']);
  $date=date('Y-m-d');
  $dateofupload = $date;
 $sql="INSERT INTO offpayment(id,holder,bookno,sno,collectiondate,licenceno) VALUES($s,'$holder','$bookno','$sno','$collectiondate','$licenceno')";
 $sql2="INSERT INTO paytrade(id,p_applicantname,b_tradename,demand,arrear,rid,dateofupload,bookno,sno,nameuser) VALUES($s1,'$p_applicantname','$b_tradename','$demand','$arrear','$rid','$dateofupload','$bookno','$sno','$login_session')";
 $sql1="UPDATE tradecopyrenewal SET payment=1,rid='$rid' where licenceno='$licenceno'";
                    ...
                    <div class="container-fluid" style="height: 700px; overflow: hidden; overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">Offline Renew Trade Licence Challan Section</h4>
  ...
  document.getElementById("sno").innerHTML=response; 
                        ...
                        <option value="DeepDas">Deep Kumar Das</option>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="licenceno" name="licenceno" onkeyup="loaddata();" placeholder="Trade Licence No" required>
                                                </div>
                                            </div>
