...
overflow-y: scroll;">
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">Know your room details:</h4>
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Your room details</h4>
                                    <div class="table-responsive">
                                        <table class="table mails m-0 table table-actions-bar">
                                            ...
                                            <tbody>
                                                <?php
					                        		$product_array = "SELECT * FROM roompay order by id desc";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        <a href="receiptroom.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Print Receipt</button></a> 
                                                    </td>
