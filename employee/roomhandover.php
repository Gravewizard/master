...
require_once("dbconnect.php");
 ...
 $r_roomno = mysqli_real_escape_string($link, $_POST['r_roomno']);
 $r_roomrent = mysqli_real_escape_string($link, $_POST['r_roomrent']);
 ...
 $sql="INSERT INTO roomownership(r_roomno,r_roomrent,o_ownerfathername,o_ownername,o_ownerphone,o_owneraddress) VALUES('$r_roomno','$r_roomrent','$o_ownerfathername','$o_ownername','$o_ownerphone','$o_owneraddress')";
...
overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">APPLICATION FOR SURRENDER OF ROOMS</h4>
						...
						<div class="row">
						     <div class="col-md-12">
										<h4><center>Application form for surrender of rooms 2017-2018</center></h4>
										<form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
										<div class="card-box">
											<h4>Room Details</h4><br>
											<div class="form-group">
                                                <label class="col-md-2 control-label">Room No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="r_roomno" id="r_roomno" class="form-control" placeholder="Room No." required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Room Rent</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="r_roomrent" id="r_roomrent" class="form-control" placeholder="Room Rent" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-box">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="o_ownername" id="o_ownername" class="form-control" placeholder="Owner Name" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Owner Father's Name</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="o_ownerfathername" id="o_ownerfathername" class="form-control" placeholder="Owner Father Name" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Owner Phone No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="o_ownerphone" id="o_ownerphone" class="form-control" placeholder="Owner Phone No." required>
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-2 control-label">Owner Address/Details</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="o_owneraddress" name="o_owneraddress" placeholder="Owner Address" required>
                                                </div>
                                            </div>
