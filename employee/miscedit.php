...
$id=intval($_GET['id']);
 ...
 $sql="UPDATE misc_collection SET p_applicantname='$p_applicantname',p_mobile='$p_mobile',p_address='$p_address',p_amountpayable='$p_amountpayable',p_allotmentno='$p_allotmentno',
 p_referno='$p_referno',p_amount='$p_amount' WHERE id='$id'";

 if(mysqli_query($link, $sql)){
 ?>
	 <script>alert('Your update is done');</script>
 <?php
                ...
                <div id="page-right-content">
                    ...
                    <div class="container-fluid">
						...
						<div class="row">
						     <div class="col-md-12">
						                <div class="head">
										        <h4 style="float:left;">Misc. Collection</h4>
										</div>
										<form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
										<?php
					                        		$product_array = "SELECT * FROM misc_collection where id='$id'";
										...
										<div class="card-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="p_applicantname" id="p_applicantname" class="form-control" value="<?php echo $row['p_applicantname']; ?>" y>
                                                </div>
                                            </div>
											<div class="form-group">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="p_address" name="p_address" value="<?php echo $row['p_address']; ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Amount Payable For</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="p_amountpayable" name="p_amountpayable" value="<?php echo $row['p_amountpayable']; ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Allotment No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="p_allotmentno" name="p_allotmentno" value="<?php echo $row['p_allotmentno']; ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Reference No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="p_referno" name="p_referno" value="<?php echo $row['p_referno']; ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Amount</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="p_amount" name="p_amount" value="<?php echo $row['p_amount']; ?>" >
                                                </div>
                                            </div>
										</div>
										<?php } ?>
            ...
            <div class="btn-group">
                ...
                <label for="fancy-checkbox-danger-custom-icons" class="btn btn-default btn-xs active">
                    NOC From Land Owner
										...
										<div class="print" style="padding-top: 10%;"><button type="submit" class="btn btn-primary" >Update</button></div>
                                        </form>
                                    </div>
						</div>
