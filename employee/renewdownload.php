...
overflow-y: scroll;">
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">Print/View your renewed trade license details:</h4>
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Your details of renewed trade license</h4>
                                        ...
                                        <table class="table mails m-0 table table-actions-bar">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="renewtradecopy.php?sid=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">View</button></a> 
                                                    </td>
