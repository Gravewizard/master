...
require_once("dbconnect.php");
 ...
 $sql="INSERT INTO bhetiownership(b_bhetino,b_bhetiname,b_bhetiaddress,o_ownername,o_ownerphone,o_owneraddress) VALUES('$b_bhetino','$b_bhetiname','$b_bhetiaddress','$o_ownername','$o_ownerphone','$o_owneraddress')";
						     ...
						     <div class="col-md-12">
										...
										<div class="card-box">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="b_bhetino" id="b_bhetino" class="form-control" placeholder="Bheti No." required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Bheti Name</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="b_bhetiname" id="b_bhetiname" class="form-control" placeholder="Bheti Name" required>
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-2 control-label">Bheti Address/Details</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="b_bhetiaddress" name="b_bhetiaddress" placeholder="Bheti Address" required>
                                                </div>
                                            </div>
