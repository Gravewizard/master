                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <form role="search" class="navbar-left app-search pull-center">
                                         <input type="text" placeholder="Your room no" class="form-control">
                                         <a href=""><i class="fa fa-search"></i></a>
									</form>
                                        ...
                                        <table class="table mails m-0 table table-actions-bar">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <b><?php echo $row['o_ownername']; ?></b>
                                                    </td>

                                                    

                                                    <td>
                                                        <b> <?php echo $row['r_roomno']; ?></b>
                                                    </td>
                                                    
                                                    <td>
                                                        <a href="roompay.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Pay Amount</button></a>
                                                    </td>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <form role="search" class="navbar-left app-search pull-center">
                                         <input type="text" placeholder="Your trade license no" class="form-control">
                                         <a href=""><i class="fa fa-search"></i></a>
									</form>
                                        ...
                                        <table class="table mails m-0 table table-actions-bar">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row['p_applicantname']; ?>
                                                    </td>

                                                    

                                                    <td>
                                                        <b><?php echo $row['b_tradetype']; ?></b>
                                                    </td>

                                                    <td>
                                                        <b><?php echo $row['b_tradename']; ?></b>
                                                    </td>
