                                ...
                                <div class="card-box">
                                    <div class="table-responsive">
                                        <table class="table mails m-0 table table-actions-bar">
                                            ...
                                            <tbody>
                                                <?php
					                        		$product_array = "SELECT * FROM misc_collection";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="miscpay.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Pay Amount</button></a>
