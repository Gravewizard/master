...
$id=intval($_GET['id']);
 ...
 $sql="INSERT INTO roompay(r_roomno,o_ownername,o_owneraddress,referno,latefine,amount) VALUES('$r_roomno','$o_ownername','$o_owneraddress','$referno','$latefine','$amount')";
 ...
 if(mysqli_query($link, $sql)){
	    ...
	    echo '<script type="text/javascript">
           window.location = "http://egramin.co.in/dhingmb/roomreceipt.php"
      </script>';
						     ...
						     <div class="col-md-12">
										...
										<div class="card-box">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="r_roomno" id="r_roomno" class="form-control" value="<?php echo $row['r_roomno']; ?>"  readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
											...
											<div class="form-group">
                                                <label class="col-md-2 control-label">Room Address/Details</label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="amount" name="amount" value="<?php echo $row['r_roomrent']; ?>"  readonly>
                                                </div>
                                            </div>
                                            <?php 
                                            $lastdate= ("2017-09-15");
    ...
    return $datetime->format('Y\-m\-d\ h:i:s');
                                           ...
                                           if($todaydate>$lastdate){
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="latefine" name="latefine" value="5" readonly>
                                                </div>
                                            </div>
											<?php } ?>
