...
overflow-y: scroll;">
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">Renew your trade license details:</h4>
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Trade licenses are below:</h4>
                                        ...
                                        <table class="table mails m-0 table table-actions-bar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Trade type</th>
                                                    <th>Trade name</th>
                                                    <th>Option for Renewal</th>
                                                </tr>
                                            </thead>

                                            <tbody>
                                                <?php
					                        		$product_array = "SELECT * FROM applytrade where p_year!='2017-2018'";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="tradelicence7.php?sid=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Renew</button></a> 
                                                    </td>
