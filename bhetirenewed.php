...
if($_POST)
{
$select=mysqli_query($link,"SELECT COUNT(*) FROM renewbheti");
...
$date=date('Y-m-d');
$dateofupload = $date;
$sql="INSERT INTO renewbheti(id,p_applicantname,p_fathersname,p_mobile,bhetino,arrearupto,demand,total,date,photo,rebate,fine) VALUES($s,'$p_applicantname','$p_fathersname','$p_mobile','$bhetino','$arrearupto','$demand','$total','$dateofupload','$photo','$rebate','$fine')";
$sql1="UPDATE bhetirenewal SET renewed=1 WHERE id='$id'";
if(mysqli_query($link, $sql)){
if(mysqli_query($link, $sql1)){
header("Location: bhetirenewal.php"); /* Redirect browser */
 exit();
  }else{
                ...
                <form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-box">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" id="p_mobile" name="p_mobile" value="<?php echo $row['phone']; ?>" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    function add() {
                    a = Number(document.getElementById('arrearupto').value);
                    b = Number(document.getElementById('demand').value);
                    c = Number(document.getElementById('rebate').value);
                    d = Number(document.getElementById('fine').value);
                    p= a+b+c+d;
                    document.getElementById('tamount').value = p;
                    } </script>
                    <div class="form-group">
                      <label class="col-md-2 control-label">Arrear Upto</label>
                      <div class="col-md-10">
                        <input type="text" class="form-control" id="arrearupto" name="arrearupto" value="<?php echo $row['arrear']; ?>" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" id="fine" name="fine" value="<?php echo $row['fine']; ?>" onKeyUp="add()">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-2 control-label">Total Due Amount</label>
                      <div class="col-md-10">
                        <input type="text" class="form-control" id="tamount" name="tamount">
                      </div>
                    </div>
                    <div class="form-group">
