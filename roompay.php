...
$id=intval($_GET['id']);
 ...
 $totaldue = mysqli_real_escape_string($link, $_POST['totaldue']);
 $referno = mysqli_real_escape_string($link, $_POST['referno']);
 $latefine = mysqli_real_escape_string($link, $_POST['latefine']);
 $ward = mysqli_real_escape_string($link, $_POST['ward']);
 $road = mysqli_real_escape_string($link, $_POST['road']);

 $sql="INSERT INTO paytrade(roomno,p_applicantname,arrearupto,demand,totaldue,fine,ward,road) VALUES('$roomno','$p_applicantname','$arrearupto','$demand','$totaldue','$latefine','$ward','$road')";

 if(mysqli_query($link, $sql)){

	     $sql1="UPDATE roomownership SET payment=1 where id='$id'";
	    if(mysqli_query($link, $sql1)){
	    echo '<script type="text/javascript">
           window.location = "http://egramin.co.in/dhingmb/receiptafterroompayment.php"
      </script>';
...
overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">Payment window</h4>
  ...
  b = Number(document.getElementById('demandupto').value);
  c = Number(document.getElementById('latefine').value);
  d= a+b+c; 

  document.getElementById('totaldue').value = d;
} </script>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Arrear Upto 31-03-2017</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="arrearupto" name="arrearupto" value="<?php echo $row['arrearupto']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Demand 2017-2018</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="demand" name="demand" value="<?php echo $row['demand']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Late Fine</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="latefine" name="latefine" placeholder="enter the amount of latefine" onKeyUp="multiply()">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Total Due</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="totaldue" name="totaldue">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="referno" name="referno" placeholder="write reference no">
                                                </div>
                                            </div>
										</div>
