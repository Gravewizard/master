        ...
        <div id="page-wrapper">
            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 700px;overflow: hidden;">
                        
						<div class="row">
                            <div class="col-sm-12">
                                
                                    <h4 class="m-t-0">APPLICATION FOR THE RENEWAL BHETI DATA</h4>
						...
						<div class="row">
						     <div class="col-md-12">
										...
										<h4><center>BHETI DEMAND REGISTRAR FOR 2017-2018</center></h4>
										...
										<div class="card-box">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="arrear" name="arrear" value="<?php echo $row['arrear']; ?>" readonly>
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Breadth(feet)</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="area_b_feet" name="area_b_feet" value="<?php echo $row['area_b_feet']; ?>">
                                                </div>
                                            
                                                <label class="col-md-2 control-label">Breadth(inch)</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="area_b_inch" name="area_b_inch" value="<?php echo $row['area_b_inch']; ?>" readonly>
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Length(feet)</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="area_l_feet" name="area_l_feet" value="<?php echo $row['area_l_feet']; ?>" readonly>
                                                </div>
                                            
                                                <label class="col-md-2 control-label">Length(inch)</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="area_l_inch" name="area_l_inch" value="<?php echo $row['area_l_inch']; ?>" readonly>
                                                </div>
                                            </div>  
                      <div class="form-group">
