...
$id=intval($_GET['id']);
 if($_POST)
 {
   ...
   $b_tradetype = mysqli_real_escape_string($link, $_POST['p_amountpayable']);
   $b_tradename = mysqli_real_escape_string($link, $_POST['p_allotmentno']);  	
   $b_cost = mysqli_real_escape_string($link, $_POST['p_amount']);
   ...
   $date=date('Y-m-d');
   $dateofupload = $date;
 $sql1="INSERT INTO paytrade(id,p_applicantname,b_tradetype,b_tradename,b_cost,chqdrft,chqdrftno,rid,dateofupload,nameuser) VALUES($s,'$p_applicantname','$b_tradetype','$b_tradename','$b_cost','$chqdrft','$chqdrftno','$rid','$dateofupload','$login_session')";  	
 

 $sql="UPDATE misc_collection SET payment=1 WHERE id='$id'";

  if(mysqli_query($link, $sql)){
     if(mysqli_query($link, $sql1)){
 header("Location: printformreceipt.php"); /* Redirect browser */
exit();
						     ...
						     <div class="col-md-12">
										...
										<div class="card-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="chqdrft" name="chqdrft" value="<?php echo $row['chqdrft']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Cheque No. / Draft No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="chqdrftno" name="chqdrftno" value="<?php echo $row['chqdrftno']; ?>">
                                                </div>
                                            </div>
										</div>
										<?php } ?>
