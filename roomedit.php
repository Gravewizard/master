...
// $total= mysqli_real_escape_string($link, $_POST['total']);
 ...
 $dateofupload = $date;
  ...
  $sql="UPDATE roomownership SET o_ownername='$p_applicantname', o_ownerfathername='$p_fathersname', o_ownerphone='$p_mobile', r_roomno='$roomno', arrearupto='$arrearupto', demandupto='$demand', ward='$ward', road='$road', photo='$filename' WHERE id='$id'";
                    ...
                    <div class="container" style="height: 700px;overflow: hidden;overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">APPLICATION FOR THE RENEWAL ROOM</h4>
						...
						<div class="row">
						     <div class="col-md-12">
						         <?php
					                        ...
					                        ?>
										<h4><center>ROOM DEMAND REGISTRAR 2017-2018</center></h4>
										...
										<div class="card-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="p_applicantname" id="p_applicantname" class="form-control" value="<?php echo $row['o_ownername']; ?>" <?php if($login_session!='lakhya') { ?> readonly <?php } ?>>
												</div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-2 control-label">Father/Husband Name</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="p_fathersname" name="p_fathersname" value="<?php echo $row['o_ownerfathername']; ?>" <?php if($login_session!='lakhya') { ?> readonly <?php } ?>>
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-2 control-label">Mobile No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="p_mobile" name="p_mobile" value="<?php echo $row['o_ownerphone']; ?>" >
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-2 control-label">Room No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="roomno" name="roomno" value="<?php echo $row['r_roomno']; ?>" >
                                                </div>
                                            </div>
                      <div class="form-group">
											...
											<!--<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="total" name="total" value="<?php echo $row['totaldue']; ?>.00">
                                                </div>
                                            </div> -->
                                            <div class="form-group">
