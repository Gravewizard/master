...
if($link === false){
 ...
 $sql="UPDATE renewtrade SET p_applicantname='$p_applicantname', p_fathersname='$p_fathersname', p_mobile='$p_mobile', oldtrade='$oldtrade', tradename='$tradename', arrearupto='$arrearupto', demand='$demand', total='$total', ward='$ward', road='$road', bheti='$bheti', natureoftrade='$natureoftrade', photo='$filename' WHERE id='$id'";
						         ...
						         <?php
										...
										<div class="card-box">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="oldtrade" name="oldtrade" value="<?php echo $row['oldtrade']; ?>">
                                                </div>
                                            </div>
											<div class="form-group">
