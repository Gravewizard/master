...
if($_POST)
{
  ...
  $ridd=$rid+6300001;
  $sql="INSERT INTO offpayment(id,holder,bookno,sno,collectiondate,holdingno,paid) VALUES($s,'$holder','$bookno','$sno','$collectiondate','$holdingno','$pay')";
  $sql1="INSERT INTO paytrade(id,p_applicantname,rid,dateofupload,bookno,sno,oldholdingno,arrearptax,demandptax,totalptax,arrearltax,demandltax,totalltax,total,fine,rebate,nameuser) VALUES($s1,'$p_applicantname','$ridd','$dateofupload','$bookno','$sno','$holdingno','$arrearptax','$demandptax','$totalptax','$arrearltax','$demandltax','$totalltax','$total','$fine','$rebate','$login_session')";
  $sql2="UPDATE holdingrenewal SET renewed=1,rid='$ridd',offpayment=1 WHERE id='$idd'";
        ...
        <div class="container" style="height: 600px; overflow: hidden; overflow-y: scroll;">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <h4 class="m-t-0">Offline Holding Renew Registrar</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <h4><center>Holding Renewal Demand 2017-2018</center></h4>
              <form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
                <div class="card-box">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input type="text" class="form-control" id="holdingno" name="holdingno" onkeyup="loaddataholding();" placeholder="Holding No" required>
                    </div>
                  </div>
                ...
                <script type="text/javascript">
                function loaddataholding()
                {
                var no=$('#holdingno').val();
                //alert(no);
                if(no)
                {
                $.ajax({
                type: 'post',
                url: 'loaddataholding.php',
                data: {
                holding_no:no,
                },
                success: function (response) {
