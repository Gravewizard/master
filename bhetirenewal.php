                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 700px;overflow: hidden;overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Your details of renewal Bheti</h4>
                                    <div class="table-responsive">
                                        
<table id="myTable">
  <tr class="header">
    <th style="width:50%;">Name</th>
    <th style="width:50%;">Option for View/Correction</th>
  </tr>
  <?php
					                        		$product_array = "SELECT * FROM renewbheti";
  ...
  <tr>
    ...
    <td>
                                                        <a href="rbhetidetails.php?id=<?php echo $row['id']; ?>"><button type="button" id="button1" class="btn btn-success" >View</button></a>
