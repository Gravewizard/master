...
if($link === false){
 ...
 if($_POST)
 {
  ...
  else
  {
    ...
    $filename = "renewholdingpassport/". $_FILES['file']['name'];
 ...
 $dateofupload = $date;
  ...
  $sql="UPDATE holdingrenewal SET name='$p_applicantname', fathersname='$p_fathersname', mobileno='$p_mobile', wardno='$wardno', oldholdingno='$oldholdingno', arrearptax='$arrearptax', arrearltax='$arrearltax', demandptax='$demandptax', demandltax='$demandltax', totalptax='$totalptax', totalltax='$totalltax', bheti='$bheti', road='$road', photo='$filename' WHERE id='$id'";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">APPLICATION FOR THE RENEWAL HOLDING</h4>
            ...
            <div class="row">
                 <div class="col-md-12">
                     <?php
                                  ...
                                  ?>
                    <h4><center>HOLDING REGISTRAR 2017-2018</center></h4>
                    ...
                    <div class="card-box">
                      ...
                      <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="p_mobile" name="p_mobile" value="<?php echo $row['mobileno']; ?>">
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Ward No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="wardno" name="wardno" value="<?php echo $row['wardno']; ?>">
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Old Holding No.</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="oldholdingno" name="oldholdingno" value="<?php echo $row['oldholdingno']; ?>">
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Arrear Upto 31-3-2017 (P.tax)</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="arrearptax" name="arrearptax" value="<?php echo $row['arrearptax']; ?>" >
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Arrear Upto 31-3-2017 (L.tax)</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="arrearltax" name="arrearltax" value="<?php echo $row['arrearltax']; ?>" >
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Demand 2017-2018 (P.tax)</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="demandptax" name="demandptax" value="<?php echo $row['demandptax']; ?>" >
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Demand 2017-2018 (L.tax)</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="demandltax" name="demandltax" value="<?php echo $row['demandltax']; ?>" >
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Total (P.tax)</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="totalptax" name="totalptax" value="<?php echo $row['totalptax']; ?>" >
                                                </div>
                                            </div>
                      <div class="form-group">
                                                <label class="col-md-2 control-label">Total (L.tax)</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="totalltax" name="totalltax" value="<?php echo $row['totalltax']; ?>" >
                                                </div>
                                            </div>
                      <div class="form-group">
