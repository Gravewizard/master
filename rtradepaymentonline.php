...
<table id="myTable">
  ...
  <?php
					                        		$product_array = "SELECT * FROM renewtrade WHERE payment=0";
  ...
  <tr>
    ...
    <td>
                                                        ...
                                                        <a href="rtradelicencedetailspay.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Pay Amount</button></a>
