...
if($link === false){
 ...
 if($_POST)
 {
     $select=mysqli_query($link,"SELECT COUNT(*) FROM renewtrade");
 ...
 $sql="INSERT INTO renewtrade(id,p_applicantname,p_fathersname,p_mobile,oldtrade,tradename,arrearupto,demand,total,date,ward,road,bheti,natureoftrade,photo) VALUES($s,'$p_applicantname','$p_fathersname','$p_mobile','$oldtrade','$tradename','$arrearupto','$demand','$total','$dateofupload','$ward','$road','$bheti','$natureoftrade','$photo')";
						         ...
						         <?php
										...
										<div class="card-box">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="oldtrade" name="oldtrade" value="<?php echo $row['licenceno']; ?>" readonly>
                                                </div>
                                            </div>
											<div class="form-group">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="natureoftrade" name="natureoftrade" value="<?php echo $row['natureoftrade']; ?>" readonly>
                                                </div>
                                            </div>
											<div class="form-group">
