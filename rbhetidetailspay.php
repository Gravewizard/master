<?php
 ...
 if($_POST)
 {
   ...
   $oldtrade = mysqli_real_escape_string($link, $_POST['bhetino']);
   $arrear = mysqli_real_escape_string($link, $_POST['arrearupto']);
   ...
   $date=date('Y-m-d');
   $dateofupload = $date;
 $sql1="INSERT INTO paytrade(id,p_applicantname,oldtrade,arrear,demand,rebate,fine,b_cost,rid,dateofupload,nameuser) VALUES($s,'$p_applicantname','$oldtrade','$arrear','$demand','$rebate','$fine','$b_cost','$rid','$dateofupload','$login_session')";

 $sql="UPDATE renewbheti SET payment=1 WHERE id='$id'";
                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 700px;overflow: hidden;overflow-y: scroll;">
						...
						<div class="row">
						     <div class="col-md-12">
						                <div class="head">
										        <h4 style="float:left;">BHETI DEMAND REGISTRAR 2017-2018</h4>                                                                   
                                                                          
										
										</div>
										<form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
										<?php
					                        		$product_array = "SELECT * FROM renewbheti where id='$id'";
