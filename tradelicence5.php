        ...
        <div id="page-right-content">
          <div class="container" style="
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card-box">
                  <h4 class="m-t-0">New Applied trade license</h4>
                  <div class="table-responsive">
                    <table id="myTable">
                      <tr class="header">
                        <th style="width:40%;">Name</th>
                        <th style="width:30%;">Licence No</th>
                        <th style="width:30%;">Option for View</th>
                      </tr>
                      <tbody>
                        <?php
                        ...
                        <tr>
                          ...
                          <td>
                            <b><?php echo $row['licenceno']; ?></b>
                          </td>
                          
                          <td>
                            <a href="tradecopy.php?sid=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">View</button></a>
                          </td>
                        </tr>
                        <?php } ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <b><?php echo $row['oldtrade']; ?></b>
                          </td>
                          
                          <td>
                            <a href="rtradecopy.php?sid=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">View</button></a>
                          </td>
                        </tr>
                        <?php } ?>
                        ...
                        <?php
                                      $product_array = "SELECT * FROM tradecopyrenewal where payment=1 and rid!='NULL'";
                                      $rs = mysqli_query($link,$product_array);
                                      while($row = mysqli_fetch_array($rs)) {
                        ?>
                        <tr>
                          ...
                          <td>
                            <a href="rrtradecopy.php?sid=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">View</button></a>
                          </td>
                        </tr>
                        <?php } ?>
    ...
    if (td) {
      if (td.innerHTML.toUpperCase().indexOf(filter) > -1) {
        ...
        tr[i].style.display = "none";
                ...
                <!--<div class="card-box">
                  <h4 class="m-t-0">Renewed trade license</h4>
                  <div class="table-responsive">
