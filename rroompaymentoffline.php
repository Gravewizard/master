<?php
 ...
 $roomno = mysqli_real_escape_string($link, $_POST['roomno']);
  ...
  $date=date('Y-m-d');
  $dateofupload = $date;
 $sql="INSERT INTO offpayment(id,holder,bookno,sno,collectiondate,roomno,arrearupto,demand,total) VALUES($s,'$holder','$bookno','$sno','$collectiondate','$roomno','$arrearupto','$demand','$b_cost')";
 $sql2="INSERT INTO paytrade(id,p_applicantname,b_cost,rid,dateofupload,bookno,sno,arrearupto,demand) VALUES($s1,'$p_applicantname','$b_cost','$rid','$dateofupload','$bookno','$sno','$arrearupto','$demand')";
 $sql1="UPDATE renewroom SET payment=1 where roomno='$roomno'";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">Offline Renew Room Registrar</h4>
...
function fetch(val)
{
 ...
 ?>
                      ...
                      <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="roomno" name="roomno" onkeyup="loaddataroomold();" placeholder="Room No" required>
                                                </div>
                                            </div>
