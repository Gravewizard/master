                        ...
                        <div class="col-md-12">
                            ...
                            <div class="headreceipt" style="padding-bottom: 20px;">
                                <div class="left" style="float:left;">
                                    ...
                                    <p>SL No. : DMB/36/2017-18/0<?php echo ($row1['id']); ?> (New) </p>
                                    <?php } ?>
                                </div>
                            ...
                            <form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
                                ...
                                ?>
                                <div class="card-box">
                                    <h4>Received From : <?php echo $row['p_applicantname']; ?></h4>
                                    
                                    
                                    
                                    <?php
                                                                $product_array = "SELECT * FROM approvedtrade where rid='$id'";
                                                                $rs = mysqli_query($link,$product_array);
                                                                $row1 = mysqli_fetch_array($rs);
                                    ...
                                    ?>
                                    <h4>Trade Type : <?php echo $row1['b_tradetype']; ?></h4>
                                    <h4>Licence No : <?php if($row1['id']>49){ ?>
                                    DMB/TL/2018-2019/00<?php echo ($row1['id']-49) ?>
                                    <?php }
                                    else {
                                    echo $row['licenceno']; 
                                    } ?></h4>
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="print" style="padding-top: 6%;">
                                    <button id="printpagebutton" class="btn btn-primary" onclick="printpage()" type="submit">Print</button>
                                </div>
                            </form>
