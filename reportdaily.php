...
.column {
    ...
    width: 50%;
    padding: 10px;
    height: 165px; /* Should be removed. Only for demonstration */
}
</style>
    </head>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <form role="search" class="navbar-left app-search pull-center">
                                        <input type="date" id="myInput1" placeholder="Enter the start date...." class="form-control">
                                         <input type="date" id="myInput2" onkeyup="myFunction();" placeholder="Enter the end date...." class="form-control">
									                   </form>
...
function myFunction(val1,val2) {
 ...
 url: 'getdate.php',
 data: {
  get_option1: $("#myInput1").val(),
  get_option2: $("#myInput2").val()
 },
 success: function (response) {
  document.getElementById("myTable").innerHTML=response; 
 }
 });
}
                            </script>
