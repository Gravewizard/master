                ...
                <div id="page-right-content">
                    ...
                    <div class="container"   style="height: 600px;overflow: hidden;overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Room Payment Receipt download</h4>
                                    <div class="table-responsive">
                                        
<table id="myTable">
  <tr class="header">
    <th style="width:60%;">Name with date of payment</th>
    <th style="width:40%;float:right;">Option for View/Payment</th>
  </tr>
  <?php
					                        		$product_array = "SELECT * FROM roommonthly ORDER BY id DESC";
							                        $rs = mysqli_query($link,$product_array);
							                        while($row = mysqli_fetch_array($rs)) {
					                            ?>
  <tr>
    <td><?php echo $row['o_ownername']; ?> (<?php echo $row['dateofupload']; ?>) || Mode of Payment : <?php if($row['bookno']!=NULL){?><b>Offline</b><?php } else {?><b> Online</b> <?php }
    ?> </td>
    <td>
                                                        <a href="receiptroom.php?sid=<?php echo $row['rid']; ?>"><button type="submit" style="float:right;" name="submit" id="submit" class="btn btn-primary">Print Receipt</button></a>   
                                                        </td>
  </tr>
  <?php } ?>
