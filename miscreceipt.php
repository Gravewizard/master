						     ...
						     <div class="col-md-12">
						     		<?php
										...
										<div class="card-box">
											...
											<h4>Reference No. : <?php echo $row['p_referno']; ?></h4>
											<h4>Amount Payable For : <?php echo $row['p_amountpayable']; ?></h4>
											<h4>Payment By : <?php echo $row['chqdrft']; ?>&nbsp;&nbsp;&nbsp;&nbsp;Cheque/Draft No : <?php echo $row['chqdrftno']; ?></h4>
                                            ...
                                            <tbody style="border: 1px solid black;">
                                                ...
                                                <th scope="row">1</th>
                                                <td>Allotment No : (<?php echo $row['p_allotmentno']; ?>)</td>
