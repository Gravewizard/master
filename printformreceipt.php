...
overflow-y: scroll;">
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">Misc. Collection details:</h4>
                                ...
                                <div class="card-box">
                                    <div class="table-responsive">
                                        <table class="table mails m-0 table table-actions-bar">
                                            ...
                                            <tbody>
                                                <?php
					                        		$product_array = "SELECT * FROM misc_collection ORDER BY id DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="miscviewprint.php?id=<?php echo $row['id']; ?>"><button type="button" id="button1" class="btn btn-success" >View & Print</button></a>
                                                        <?php } if($row['payment']==0) { ?>
                                                        <a href="miscpay.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Online Pay</button></a><br><br>
                                                        <a href="miscpay.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Offline Pay</button></a><br><br>
                                                        <a href="miscedit.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Edit</button></a>
                                                        <?php } ?>
                                                    </td>
