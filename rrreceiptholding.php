...
@page { size: auto;  margin: 0mm; }
						     ...
						     <div class="col-md-12">
						     				...
						     				<div class="headreceipt" style="padding-bottom: 20px;">
						     					<div class="left" style="float:left;">
                                                     ...
                                                     <?php
                                                    $product_array = "SELECT * FROM paytrade where rid='$id'";
                                                    $rs = mysqli_query($link,$product_array);
                                                    $row1 = mysqli_fetch_array($rs);
                                                    if($row1['id']>295){       
                                            ?>
                                                    <p>SL No. : DMB/36/2018-19/0<?php echo ($row1['id']-295); ?> (New) </p>
                                                <?php } 
                                                else {?>
                                                    <p>SL No. : DMB/36/2018-19/0<?php echo ($row1['id']); ?> (New) </p>
                                                <?php } ?>
						     					</div>
						     					<div class="right" style="float:right;">
						     						<p>Date : <?php echo $row1['dateofupload']; ?></p>
						     					</div>
						     				</div>
										...
										<form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
										    <?php
					                        		$product_array = "SELECT * FROM holdingrenewal where rid='$id'";
							                        $rs = mysqli_query($link,$product_array);
										...
										<div class="card-box">
										    ...
										    <h5>Received From: <?php echo $row['name']; ?></h5>
                                            <h5>Holding No: <?php echo $row['oldholdingno']; ?></h5>
                                            ...
                                            <?php if($row['paid']==NULL) { ?>
                                            <tbody style="border: 1px solid black;">
                                                <tr style="border: 1px solid black;">
                                                <th scope="row">1</th>
                                                <?php if($row1['id']>195){ ?>
                                                <td>Paid Amount for the year of 2018-2019</td>
                                                <?php }
                                                else { ?>
                                                <td>Paid Amount for the year of 2017-2018</td>
                                                <?php } ?>
                                                <td><?php echo ($row['demandptax']+$row['demandltax']); ?></td>
                                                <td>00</td>
                                                </tr>
                                                <tr style="border: 1px solid black;">
                                                <th scope="row">2</th>
                                                <td>Arrear Upto(31-03-2018)</td>
                                                <td><?php echo ($row['arrearptax']+$row['arrearltax']); ?></td>
                                                <td>00</td>
                                                </tr>
                                                <tr style="border: 1px solid black;">
                                                <th scope="row">3</th>
                                                <td>Rebate</td>
                                                <td><?php echo $row1['rebate']; ?></td>
                                                <td>00</td>
                                                </tr>
                                                ...
                                                <?php $total=$row['demandptax']+$row['arrearptax']+$row['demandltax']+$row['arrearltax']+$row1['fine']+$row1['rebate']; ?>
                                                <tr style="border: 1px solid black;">
                                                <th scope="row"></th>
                                                <td>Net Amount</td>
                                            ...
                                            <?php }
                                                ...
                                                <?php $total=$row['paid']+$row1['fine']+$row1['rebate']; ?>
                                                <tr style="border: 1px solid black;">
                                                <th scope="row"></th>
                                                <td>Net Amount</td>
                                                <td>Rs. <?php echo $total; ?> </td>
  ...
  echo $result . "Rupees Only ";
                                        ...
                                        <div class="sign" style="padding-top: 1%;">
                                            ...
                                            ?>
                                                <p style="text-align: center;"><?php echo strtoupper($row1['nameuser']); ?></p>
                                            </div>
                                            <div class="right" style="float:right;">
                                            	<p>________________________</p>
