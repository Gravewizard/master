                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 700px;overflow: hidden;overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Your details of renewable holding data</h4>
...
<table id="myTable">
  ...
  <?php
					                        		$product_array = "SELECT * FROM renewholding WHERE payment=0";
  ...
  <tr>
    ...
    <td>
                                                        ...
                                                        <a href="rholdingdetailspay.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Pay Amount</button></a>
