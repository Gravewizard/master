                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 700px;overflow: hidden;overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Your details of renewal Rooms</h4>
...
<table id="myTable">
  ...
  <?php
					                        		$product_array = "SELECT * FROM renewroom";
  ...
  <tr>
    ...
    <td>
                                                        <a href="rroomdetails.php?id=<?php echo $row['id']; ?>"><button type="button" id="button1" class="btn btn-success" >View</button></a>
                                                        </td>
  </tr>
  <?php } ?>
