...
$id=intval($_GET['id']);
 ...
 $sql="INSERT INTO bhetipay(b_bhetino,b_bhetiname,b_bhetiaddress,referno,latefine,amount) VALUES('$b_bhetino','$b_bhetiname','$b_bhetiaddress','$referno','$latefine','$amount')";

 if(mysqli_query($link, $sql)){
        
	    $sql1="UPDATE bhetiownership SET payment=1 where id='$id'";
	    if(mysqli_query($link, $sql1)){
	    echo '<script type="text/javascript">
           window.location = "http://egramin.co.in/dhingmb/bhetireceipt.php"
      </script>';
						     ...
						     <div class="col-md-12">
										...
										<div class="card-box">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" id="amount" name="amount" placeholder="write the amount">
                                                </div>
                                            </div>
                                            <?php 
                                            $lastdate= ("2017-09-15");
