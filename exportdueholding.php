...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading">
            <a href="exportDueholdingc.php" class="btn btn-success pull-left">Export Data(Current Year)</a>
            <a href="exportDueholdingcr.php" class="btn btn-success pull-right">Export Data(Renewal)</a>
        </div>
