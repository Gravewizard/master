...
$date=date('Y-m-d');
$dateofupload = $date;
$sql1="INSERT INTO paytrade(id,p_applicantname,bhetino,demand,rebate,fine,total,rid,dateofupload,nameuser) VALUES($s,'$ownername','$bhetino','$demand','$rebate','$fine','$total','$rid','$dateofupload','$login_session')";
$sql="UPDATE bhetiownership SET payment=1 WHERE id='$id'";
if(mysqli_query($link, $sql1)){
if(mysqli_query($link, $sql)){
header("Location: receiptafterbhetipayment.php"); /* Redirect browser */
exit();
  }
  else{
      ...
      <div id="page-right-content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="head">
                <h4 style="float:left;">Bheti Demand Form 2017-2018</h4>
              ...
              <form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="card-box">
                  ...
                  <div class="form-group">
                    <div class="hidden" style="display:none;">
                      ...
                      <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        <input type="text" name="rid" id="rid" class="form-control" value="7000<?php echo $row['id']; ?>" readonly>
                      </div>
                    </div>
                    <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Owner Name</label>
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                      <input type="text" name="ownername" id="ownername" class="form-control" value="<?php echo $row['ownername']; ?>" readonly>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                      <input type="text" class="form-control" id="ownerfathersname" name="ownerfathersname" value="<?php echo $row['ownerfathersname']; ?>" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    
                    <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Bheti No</label>
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                      <input type="text" class="form-control" id="bhetino" name="bhetino" value="<?php echo $row['bhetino']; ?>" readonly>
                    </div>
                    
                  </div>
                  <div class="form-group">
                      <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Bheti Address</label>
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                      <input type="text" class="form-control" id="bhetiaddress" name="bhetiaddress" value="<?php echo $row['bhetiaddress']; ?>" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Total Area</label>
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                      <input type="text" class="form-control" id="total_area" name="total_area" value="<?php echo $row['total_area']; ?>" readonly>
                    </div>
                  ...
                  <div class="form-group">
                    <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Demand</label>
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                      <input type="text" class="form-control" id="demand" name="demand" value="<?php echo $row['demand']; ?>" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Rebate</label>
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                      <input type="text" class="form-control" id="rebate" name="rebate" placeholder="rebate">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Fine</label>
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                      <input type="text" class="form-control" id="fine" name="fine" placeholder="fine">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Total</label>
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
