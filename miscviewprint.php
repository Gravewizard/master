                ...
                <div id="page-right-content">
                    ...
                    <div class="container-fluid">
						...
						<div class="row">
						     <div class="col-md-12">
						                <div class="head">
										        <h4 style="float:left;">Misc. Collection Form Print and Receipt</h4>
										        <div id="receipt"><a href="miscreceipt.php?sid=<?php echo $id; ?>"><button type="submit" style="float:right;" name="submit" id="submit" class="btn btn-primary">Print Receipt</button></a></div>
										</div><br><br>
