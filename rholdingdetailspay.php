<?php
 ...
 if($_POST)
 {
   ...
   $date=date('Y-m-d');
   $dateofupload = $date;
 $sql1="INSERT INTO paytrade(id,p_applicantname,wardno,oldholdingno,arrearptax,arrearltax,demandptax,demandltax,totalptax,totalltax,total,rebate,fine,rid,dateofupload,nameuser) VALUES($s,'$p_applicantname','$wardno','$oldholdingno','$arrearptax','$arrearltax','$demandptax','$demandltax','$totalptax','$totalltax','$total','$rebate','$fine','$rid','$dateofupload','$login_session')";

 $sql="UPDATE renewholding SET payment=1 WHERE id='$id'";

 if(mysqli_query($link, $sql1)){
        if(mysqli_query($link, $sql)){
 header("Location: receiptafterholdingpayment.php"); /* Redirect browser */
exit();
...
overflow: visible;
                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 700px;overflow: hidden;overflow-y: scroll;">
						...
						<div class="row">
						     <div class="col-md-12">
						                <div class="head">
										        <h4 style="float:left;">HOLDING DEMAND REGISTRAR 2017-2018</h4>                                                                   
                                                                          
										
										</div>
										<form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
										<?php
					                        		$product_array = "SELECT * FROM renewholding where id='$id'";
    ...
    ">Personal Details</h4>
                                            ...
                                            <div class="form-group">
                                                <label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">Old Holding No.</label>
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <input type="text" class="form-control" id="total" name="total" value="<?php echo ($row['totalptax']+$row['totalltax']); ?>" readonly>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <input type="text" class="form-control" id="fine" name="fine" value="<?php echo $row['fine']; ?>" readonly>
                                                </div>
                                            <label class="col-md-2 control-label">Rebate</label>
                                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                    <input type="text" class="form-control" id="rebate" name="rebate" value="<?php echo $row['rebate']; ?>" readonly>
                                                </div>
                                            </div>
