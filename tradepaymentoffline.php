<?php
 ...
 $sql2="INSERT INTO paytrade(id,p_applicantname,b_tradetype,b_tradename,b_cost,rid,dateofupload,bookno,sno) VALUES($s1,'$p_applicantname','$b_tradetype','$b_tradename','$b_cost','$rid','$dateofupload','$bookno','$sno')";
 $sql1="UPDATE applytrade SET payment=1 where licenceno='$licenceno'";
                    ...
                    <div class="container-fluid" style="height: 700px; overflow: hidden; overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <h4 class="m-t-0">Offline New Trade Licence Challan Section</h4>
