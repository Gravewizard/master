                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 600px; overflow: hidden; overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Old applied holding data</h4>
...
<table id="myTable">
  ...
  <th style="width:20%;">Old Holding No</th>
    <th style="width:20%;">Option for Renew</th>
  </tr>
  <?php
					                        		$product_array = "SELECT * FROM holdingrenewal";
  ...
  <tr>
    ...
    <td> 
    <?php if(($row['renewed']==0) && ($row['paid']==NULL)) { ?>                                                    
        <a href="holdingrenewed.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Renew</button></a>
        <a href="holdingedit.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Edit</button></a>
    <?php } 
    elseif (($row['renewed']==2)) { ?>
        <button type="button" id="button2" class="btn btn-success" >Holding is removed</button>
      
    <?php }
    else{
     ?>

        <a href="holdingview.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >View</button></a>
        <a href="holdingrenewedd.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Renew</button></a>
      <?php } ?>
    </td>
  </tr>
  <?php } ?>
