                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 600px; overflow: hidden; overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Old applied bheti data</h4>
                                    <div class="table-responsive">
                                        
<table id="myTable">
  <tr class="header">
    <th style="width:40%;">Name</th>
	<th style="width:40%;">Bheti No</th>
    <th style="width:20%;">Option for Renew</th>
  </tr>
  <?php
					                        		$product_array = "SELECT * FROM bhetirenewal";
  ...
  <tr>
    ...
    <td> 
        <?php if($row['renewed']==0) { ?>                                                    
        <a href="bhetirenewed.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Renew</button></a>
        <a href="bhetiedit.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Edit</button></a>
        <?php } 
        else { ?>
        <a href="bhetidetailsedit.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Correction</button></a> 
        <?php } ?>
    </td>
  </tr>
  <?php } ?>
