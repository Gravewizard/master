...
if($_POST)
 {
  ...
  else
  {
		...
		imagejpeg($tmp,"user/".$filename,100);
 ...
 o_ownername='$o_ownername',o_ownerfathername='$o_ownerfathername',o_ownermobile='$o_ownermobile',o_monthlyrent='$o_monthlyrent',o_ownervillage='$o_ownervillage',o_ownerholding='$o_ownerholding',o_ownerroad='$o_ownerroad',o_ownerothers='$o_ownerothers',b_cost='$b_cost',photo='$filename' WHERE id='$id'";
   ...
   // echo $rec;
    ...
    ">Holding/Room/Bheti Ownership Details</h4>
										...
										<div class="row">
											    ...
											    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                                                               <h5>Passport : <img class="img-responsive" src="user/<?php echo $row['photo']; ?>" style="width:auto;height:100px;padding-left:30%;" /></h5><br>
