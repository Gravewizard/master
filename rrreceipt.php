                ...
                <div id="page-right-content">
                    ...
                    <div class="container-fluid">
						...
						<div class="row">
						     <div class="col-md-12">
						     		<?php
					                        		$product_array = "SELECT * FROM tradecopyrenewal where rid='$id'";
										...
										<form class="form-horizontal" action="" role="form" method="post" enctype="multipart/form-data">
					                        ...
					                        ?>
										<div class="card-box">
											<h4>Received From : <?php echo $row['name']; ?></h4>
											
											<h4>Trade Name : <?php echo $row['tradename']; ?></h4>
											
                                                                                        <h4>Licence No : <?php echo $row['licenceno']; ?></h4>
