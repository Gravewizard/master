                ...
                <div id="page-right-content">
                    ...
                    <div class="container" style="height: 700px;overflow: hidden;overflow-y: scroll;">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Your details of renewal Holding</h4>
...
<table id="myTable">
  ...
  <?php
					                        		$product_array = "SELECT * FROM renewholding";
  ...
  <tr>
    ...
    <td>
      <?php if($row['payment']==0){ ?>
                                                        <a href="rholdingdetails.php?id=<?php echo $row['id']; ?>"><button type="button" id="button1" class="btn btn-success" >View</button></a>
                                                        <a href="rholdingdetailspay.php?id=<?php echo $row['id']; ?>"><button type="button" id="button1" class="btn btn-success" >Online Payment</button></a>
                                                        <a href="holdingoffline.php"><button type="button" id="button1" class="btn btn-success" >Offline Payment</button></a>
          <?php }
      else{ ?>
          <a href="rholdingdetails.php?id=<?php echo $row['id']; ?>"><button type="button" id="button1" class="btn btn-success" >View</button></a>
      <?php } ?>                                                    
