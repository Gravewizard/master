...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading">
            <a href="exportDemandlicence.php" class="btn btn-success pull-left">Export Data(Current Year)</a>
            <a href="exportDemandlicencer.php" class="btn btn-success pull-right">Export Data(Renewal)</a>
        </div>
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <?php
                    ...
                    $query = $db->query("SELECT * FROM applytrade ORDER BY b_tradetype ASC");
                    if($query->num_rows > 0){ 
                ...
                <?php
                    ...
                    //get records from database
                    $query = $db->query("SELECT * FROM renewtrade ORDER BY natureoftrade ASC");
                    if($query->num_rows > 0){ 
                        while($row = $query->fetch_assoc()){ ?>                
                    <tr>
                      <td><?php echo $row['p_applicantname']; ?></td>
