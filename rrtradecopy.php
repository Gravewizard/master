						     ...
						     <div class="col-md-12">
						     		<?php
					                        ...
					                        ?>
						     				...
						     				<div class="indiapride" style="margin-left:38%;">
						     			<img src="images/ashok.png" />
						     			</div>
										<h4><center>DHING MUNICIPAL BOARD</center></h4>
										<p><center>P.O.-DHING,DIST-NAGAON,ASSAM-782123 </center></p>
										...
										<div class="container">
										    ...
										    <div class="col-md-12" style="border: 1px solid black;">
										        <h4><center>Demand Notice for New Certificate of Enlishment for 2018-19</center></h4>
										    </div>
										    </div>
										    <div class="row">
                                                ...
                                                <div class="col-xs-4" style="border: 1px solid black;">
                                                    <p style="margin: 10px 0 10px 0;"><?php echo $row['licenceno']; ?></p>
                                                </div>
                                            ...
                                            <div class="col-xs-12" style="border: 1px solid black;">
										        <h4 style="padding: 2px;">M/S <?php echo $row['tradename'] ?></h4>
										    </div>
										    </div>
										    <div class="row">
										    <div class="col-xs-3" style="border: 1px solid black;">
                                             ...
                                             <div class="col-xs-9" style="border: 1px solid black;">
                                                    <p style="margin: 10px 0 10px 0;"><?php echo $row['name']; ?></p>
                                             </div>
                                             </div>
                                             <div class="row">
										    <div class="col-xs-4" style="border: 1px solid black;">
                                             ...
                                             <div class="col-xs-8" style="border: 1px solid black;">
                                                    <p style="margin: 10px 0 10px 0;"><?php echo $row['fathersname']; ?></p>
                                             </div>
                                             </div>
                                             <div class="row">
                                                ...
                                                <div class="col-xs-3" style="border: 1px solid black;">
                                                    <p style="margin: 10px 0 10px 0;"><?php if($row['ward']==NULL){ echo "N/A"; } else{ echo $row['ward']; } ?></p>
                                                </div>
                                                ...
                                                <div class="col-xs-6" style="border: 1px solid black;">
                                                    <p style="margin: 10px 0 10px 0;"><?php if($row['road']==NULL){ echo "N/A"; } else{ echo $row['road']; } ?></p>
                                                </div>
										    ...
										    <div class="col-xs-6" style="border: 1px solid black;">
                                             ...
                                             <div class="col-xs-6" style="border: 1px solid black;">
                                                    <p style="margin: 10px 0 10px 0;"><?php if($row['bheti']==NULL){ echo "N/A"; } else{ echo $row['bheti']; } ?></p>
                                             </div>
                                             </div>
                                             <div class="row">
										    ...
										    <div class="col-xs-3" style="border: 1px solid black;">
                                             ...
                                             <div class="col-xs-9" style="border: 1px solid black;">
                                                    <p style="margin: 10px 0 10px 0;"><?php if($row['natureoftrade']==NULL){ echo "N/A"; } else{ echo $row['natureoftrade']; } ?></p>
                                             </div>
                                             
                                             </div>
                                             <div class="row">
										    <div class="col-xs-3" style="border: 1px solid black;">
                                                   <p style="margin: 10px 0 10px 0;"><b>Valid Upto<br>31/03/19</b></p>
                                             </div>
										    ...
										    <div class="col-xs-3" style="border: 1px solid black;padding-bottom:8px;">
                                             ...
                                             <div class="col-xs-7" style="border: 1px solid black;">
                                                    <p style="margin: 10px 0 18px 0;">Trade license fees for the year 2018-2019<br>
                                                    Previous Dues<br>
                                                    <img class="img-responsive" src="<?php echo $row['photo']; ?>" style="width:auto;height:100px;padding-left:52%;" /><br>
                                                    Net Amount Payble
                                                    </p>
                                             </div>
                                             <div class="col-xs-2" style="border: 1px solid black;">
                                                   <p style="margin: 10px 0 18px 0;"><?php echo $row['demand']; ?>.00<br><?php echo $row['arrearupto']; ?>.00<br><br><br><br><br><br><?php echo $row['total']; ?>.00</p><br>
                                             </div>
                                             </div>
                                             <div class="row">
										    <div class="col-xs-3" style="border: 1px solid black;">
