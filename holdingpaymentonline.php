...
<table id="myTable">
  <tr class="header">
    ...
    <th style="width:40%;">Holding No</th>
    <th style="width:20%;">Option for View/Payment</th>
  </tr>
  <?php
					                        		$product_array = "SELECT * FROM holdingownership WHERE payment=0";
  ...
  <tr>
    ...
    <td>
                                                        ...
                                                        <a href="holdingdetailspay.php?id=<?php echo $row['id']; ?>"><button type="button" id="button2" class="btn btn-success" >Pay Amount</button></a>
